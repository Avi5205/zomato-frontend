        ...
        <div>
            ...
            <Formik initialValues={initialValues} onSubmit={handleSubmit}>
                <Form>
                    ...
                    <Field as={TextField} label="Password" name="password" fullWidth variant="outlined" margin="normal"
                           type="password"/>
                    <FormControl fullWidth margin="normal">
                        <InputLabel id="role-simple-select-label">Role</InputLabel>
                        <Field as={Select} labelId="role-simple-select-label" id="role-simple-select" name="role">
                            <MenuItem value={"ROLE_CUSTOMER"}>Customer</MenuItem>
                            <MenuItem value={"ROLE_RESTAURANT_OWNER"}>Restaurant Owner</MenuItem>
                        </Field>
                    </FormControl>
            ...
            <Typography variant="body2" align='center' sx={{mt: 3}}>
                If you already have an account?
                <Button size="small" onClick={handleLoginClick}> {/* Use the passed function */}
                    Login
                </Button>
            </Typography>
        </div>
